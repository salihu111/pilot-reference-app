"""
Lightweight SQLite layer. No external DB needed -> fits free-tier hosting
(Railway free tier gives you an ephemeral filesystem, so on Railway mount
a Volume for /data if you want the index to survive redeploys).
"""
import sqlite3
import os
import json
